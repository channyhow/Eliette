        ...
        <div className={`contact-form ${isMobile ? 'mobile-width' : ''}`}>
          ...
          <form ref={form} onSubmit={sendEmail} style={{ display: 'flex', flexDirection: 'column' }}>
            ...
            <TextField
              ...
              style={{ marginBottom: '1em' }}
            />
            <Button type="submit" style={{ margin: '1em', backgroundColor: 'rgb(3, 3, 3, 0.3)', color: '#030303' }}>
              Submit
            </Button>
          </form>
          ...
          <Dialog open={isErrorDialogOpen} onClose={handleCloseErrorDialog}>
            ...
            <DialogActions>
              <Button onClick={handleCloseErrorDialog} style={{ margin: '1em', backgroundColor: 'rgb(3, 3, 3, 0.3)', color: '#030303' }}>
                OK
              </Button>
            </DialogActions>
          </Dialog>
