        ...
        <div className={`contact-form ${isMobile ? 'mobile-width' : ''}`}>
          ...
          <form ref={form} onSubmit={sendEmail} style={{ display: 'flex', flexDirection: 'column' }}>
            ...
            <TextField
              ...
              style={{ marginBottom: '1em' }}
            />
            <Button type="submit" style={{ margin: '1em', backgroundColor: 'rgb(255, 255, 255, 0.3)', color: 'white' }}>
              Submit
            </Button>
          </form>
          ...
          <Dialog open={isErrorDialogOpen} onClose={handleCloseErrorDialog}>
            ...
            <DialogActions>
              <Button onClick={handleCloseErrorDialog} style={{ margin: '1em', backgroundColor: 'rgb(255, 255, 255, 0.3)', color: 'white' }}>
                OK
              </Button>
            </DialogActions>
          </Dialog>
